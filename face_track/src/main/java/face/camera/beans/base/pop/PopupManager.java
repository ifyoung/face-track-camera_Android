package face.camera.beans.base.pop;
...
import face.camera.beans.record.ui.ThumbnailCountDownTimeView;
...
public class PopupManager {
    ...
    //显示倒计时
    public void showCountDown(Resources res, final SelTimeBackListener pop) {
