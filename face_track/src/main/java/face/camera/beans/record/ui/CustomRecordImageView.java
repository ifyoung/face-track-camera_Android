...
import face.camera.beans.base.utils.DisplayUtil;
...
public class CustomRecordImageView extends View {
    ...
    private boolean isPic = false;//照片模式
    ...
    private void initView() {
        ...
        mStartHWidth = mStartHWidth * DisplayUtil.getScreenWidth(getContext()) / 1080;
        if (mStartHWidth <= 80) {
            mStartHWidth = 60;
        }
        if (mStartHWidth > 100) {
        ...
        mStopHWidth = (int) (mStartHWidth * 1.2);
        ...
        Log.d("CustomRecordImageView", mStartHWidth + ">>" + mStopHWidth);
    }
    ...
    public void setModelColor(boolean isPic) {
        this.isPic = isPic;
        invalidate();
    }
