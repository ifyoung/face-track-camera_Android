package face.camera.beans.record.draw;
...
import face.camera.beans.record.encoder.TextureMovieEncoder;
import face.camera.beans.record.filters.BaseFilter;
import face.camera.beans.record.filters.CameraDrawProcessFilter;
import face.camera.beans.record.filters.CameraFilter;
import face.camera.beans.record.filters.GroupFilter;
import face.camera.beans.record.filters.NoneFilter;
import face.camera.beans.record.filters.gpuFilters.baseFilter.MagicBeautyFilter;
import face.camera.beans.record.ui.SlideGpuFilterGroup;
import face.camera.beans.record.utils.EasyGlUtils;
import face.camera.beans.record.utils.MatrixUtils;
...
public class CameraDrawer implements GLSurfaceView.Renderer {
    ...
    public CameraDrawer(Resources resources) {
        Log.e("CameraDrawer", "Open Camera Resources");
...
//        mBeautyFilter = new MagicAntiqueFilter();
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        Log.e("CameraDrawer", "Open Camera to CameraDrawer-init-onSurfaceCreated");
    ...
    public void onDrawFrame(GL10 gl) {
        Log.e("onDrawFrame-Drawer", "Open Camera to onDrawFrame" + gl + isSwitch);
...
//            videoEncoder.setTextureId(fTexture[0]);
     ...
     * 切换滤镜
     */
    public void changeFilter(int pos) {
        mSlideFilterGroup.setFilter(pos);
    }
    ...
    public void setSwitch(boolean switchPause) {
        isSwitch = switchPause;
    }
