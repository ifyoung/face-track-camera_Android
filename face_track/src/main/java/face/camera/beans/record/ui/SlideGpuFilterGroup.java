...
import face.camera.beans.record.other.MagicFilterFactory;
import face.camera.beans.record.other.MagicFilterType;
import face.camera.beans.record.utils.EasyGlUtils;

import static face.camera.beans.base.utils.StaticFinalValues.types;
...
//    };
    ...
    public void onSizeChanged(int width, int height) {
        Log.e("SlideGpu-sizeChanged"," "+width+">>"+height);
        this.width = width;
        this.height = height;
...
//        }
//        Log.e("SlideGpu-onDraw"," "+textureId);
        drawCurrentFilter(textureId);
    ...
    void drawCurrentFilter(int textureId){
        GLES20.glViewport(0, 0, width, height);
        GLES20.glEnable(GLES20.GL_SCISSOR_TEST);
