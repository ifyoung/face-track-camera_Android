 ...
 vec4 NCColorMatrix(vec4 color, float red, float green, float blue, float alpha, vec4 bias)
{
 ...
 // multiply blend
 vec4 NCMultiplyBlend(vec4 overlay, vec4 face.camera.beans.base)
{
    vec4 outputColor;
    
    float a = overlay.a + face.camera.beans.base.a * (1.0 - overlay.a);
    
    //    // normal blend
    //    outputColor.r = (face.camera.beans.base.r * face.camera.beans.base.a + overlay.r * overlay.a * (1.0 - face.camera.beans.base.a))/a;
    //    outputColor.g = (face.camera.beans.base.g * face.camera.beans.base.a + overlay.g * overlay.a * (1.0 - face.camera.beans.base.a))/a;
    //    outputColor.b = (face.camera.beans.base.b * face.camera.beans.base.a + overlay.b * overlay.a * (1.0 - face.camera.beans.base.a))/a;
    
    
    // multiply blend
    outputColor.rgb = ((1.0-face.camera.beans.base.a) * overlay.rgb * overlay.a + (1.0-overlay.a) * face.camera.beans.base.rgb * face.camera.beans.base.a + overlay.a * face.camera.beans.base.a * overlay.rgb * face.camera.beans.base.rgb) / a;
