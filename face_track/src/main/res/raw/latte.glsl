...
void main()
{
	...
	textureColor = (textureColor - face.camera.beans.base) * 0.3 + face.camera.beans.base;
	...
	textureColor = vec4(ra, ga, ba, 1.0); 
	textureColor = (textureColor - face.camera.beans.base) * 0.15 + face.camera.beans.base;
